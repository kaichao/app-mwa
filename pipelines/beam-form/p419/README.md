...
- 24ch结果从共享存储拷贝回头节点
```sh
SOURCE_URL=cstu0036@60.245.128.14:65010/work1/cstu0036/mydata/mwa/24ch TARGET_URL=/data1/mydata/mwa/24ch DIR_NAME=1266932744-250121 REGEX_FILTER= KEEP_SOURCE=no scalebox app create
```
